...
- **प्लान बैज** - आपकी वर्तमान सदस्यता दिखाता है (Pro, Max 5x, Max 20x, Team, Enterprise)
- **मॉडल के अनुसार साप्ताहिक सीमाएँ** - जब आपका प्लान रिपोर्ट करे, Fable, Opus और Sonnet के लिए अलग पंक्तियाँ
- **उपयोग क्रेडिट** - एक बार के क्रेडिट और उनकी समाप्ति तिथि दिखाता है
- **अतिरिक्त उपयोग सहायता** - पे-एज़-यू-गो खर्च ट्रैक करें और यदि आपके संगठन ने इसे बंद किया है तो कारण देखें
...
- **अनुकूलन योग्य सूचनाएँ** - हर ट्रैक की गई सीमा के लिए 50%, 75%, 100% या रीसेट पर नेटिव नोटिफ़िकेशन सेंटर अलर्ट
...
ClaudeBar macOS Keychain से OAuth क्रेडेंशियल पढ़ता है जो Claude Code लॉग इन करते समय संग्रहीत करता है। फिर यह उसी उपयोग एंडपॉइंट से क्वेरी करता है जिसका उपयोग Claude Code का `/usage` कमांड करता है।

जब टोकन समाप्त होने वाला होता है, ClaudeBar उसे Claude Code के समान प्रोटोकॉल से रिफ़्रेश करता है: पहले Claude Code का रिफ़्रेश लॉक (`~/.claude.lock`) लेता है, Keychain दोबारा पढ़ता है और यदि Claude Code ने पहले ही रिफ़्रेश कर दिया है तो नया टोकन उपयोग करता है; अन्यथा स्वयं रिफ़्रेश करके उसी जगह अपडेट करता है। लेखन `security` टूल को stdin के माध्यम से दिया जाता है, इसलिए टोकन कभी प्रोसेस आर्ग्युमेंट्स में नहीं दिखता। यदि Keychain उपलब्ध न हो, तो `~/.claude/.credentials.json` का उपयोग किया जाता है।
...
पढ़ना और लिखना सिस्टम के `security` टूल के माध्यम से होता है, वही रास्ता जो Claude Code उपयोग करता है, इसलिए आमतौर पर कोई अतिरिक्त Keychain प्रॉम्प्ट नहीं आता। यदि macOS पूछे, तो **Always Allow** पर क्लिक करें।

### सूचनाएँ

पहली बार लॉन्च करने पर, macOS पूछता है कि क्या ClaudeBar सूचनाएँ दिखा सकता है। यदि आप मना करते हैं, तो बाद में System Settings › Notifications › ClaudeBar में इन्हें चालू कर सकते हैं।

### गोपनीयता

- केवल वही क्रेडेंशियल पढ़ता है जो Claude Code ने पहले से संग्रहीत किए हैं, और केवल रिफ़्रेश किए गए टोकन वापस लिखता है
